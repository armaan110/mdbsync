 ...
 */
static void set_message(u8 *msg)
{
  iowrite8_rep(dev.virtbase, msg, 37);
  memcpy(dev.msg, msg, 38);
}
...
static long vga_led_ioctl(struct file *f, unsigned int cmd, unsigned long arg)
{
  ...
  case VGA_LED_READ_MESSAGE:
    memcpy(vla.msg, dev.msg, 38);
...
{
  int ret;
  unsigned char start_msg[38] = {0xC0,0xC2,0x1C,0x02,0x3D,0x01,0x00,
				 0x00,0x68,0x03,0x80,0x01,0x00,0x00,
				 0x7B,0x00,0x00,0x00,0x0C,0x00,0x00,
				 0x00,0xA0,0x47,0x5F,0x3B,0x00,0x00,
				 0x00,0x00,0x0F,0x00,0x02,0xC9,0x00,
				 0x00,0x00};
